...
namespace ServiceRequestInformationSystem
{
    public partial class TechnicianForm : MetroFramework.Forms.MetroForm
    {
        ...
        {
            LoadTechinicianListTable();
        }

        private void LoadTechinicianListTable()
        {
            SQLCon.DbCon();
            SQLCon.sqlDataApater = new SqlDataAdapter(
                @"SELECT DISTINCT
                    SP_ID,
                    spName AS Technician
                  FROM
                    ServiceProvidedBies
                  WHERE
                    IsActive = 1
            ...
            metroGrid1.Columns[1].HeaderText = "Technician";
        ...
        private void linkLabel_AddTechnician_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
